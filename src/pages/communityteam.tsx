      ...
      <div className="flex items-center justify-center">
        ...
        <div className="bg-white rounded-[32px] shadow-xl border border-slate-200 p-12 max-w-2xl w-full text-center">
          ...
          <p className="text-slate-400 mt-6 leading-7">
            ...
            We are currently building advanced community management features
            including event coordination, volunteer tracking,
            alumni engagement, and communication dashboard.
