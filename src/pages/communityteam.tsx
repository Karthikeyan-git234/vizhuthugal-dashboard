...
setTeamData(
  ...
  const filteredData = teamData.filter((item) => {
    const matchesSearch = item.school_name?.toLowerCase().includes(search.toLowerCase())
  ...
  const activeCount = teamData.filter((item) => item.centenary_celebration_status === 'Completed').length
  const pendingCount = teamData.filter((item) => item.centenary_celebration_status === 'Pending').length
      ...
      <div className="ct-root">
        ...
        <div className="ct-header-bar">
          <div className="ct-header-left">
            <h1>Community Team Dashboard</h1>
        ...
        <div className="ct-stats">
          ...
          <div className="ct-stat green">
            <div className="ct-stat-top">
              <span className="ct-stat-label">Completed</span>
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr key={item.id}>
                    ...
                    <td>
                      <span className={`ct-badge ${item.meeting_conducted_status === 'Yes' ? 'yes' : 'no'}`}>
                        {item.meeting_conducted_status}
                      </span>
                    </td>
                    <td>
                      <span className={`ct-badge ${item.committee_formed_status === 'Yes' ? 'yes' : 'no'}`}>
              ...
              <div className="ct-modal-body">
                ...
                <div className="ct-form-grid">
                  ...
                  <div className="ct-form-group">
                    ...
                    <select
                      value={selectedItem.meeting_conducted_status || ''}
                      onChange={(e) => setSelectedItem({ ...selectedItem, meeting_conducted_status: e.target.value })}
                    >
                  ...
                  <div className="ct-form-group">
                    ...
                    <select
                      value={selectedItem.committee_formed_status || ''}
                      onChange={(e) => setSelectedItem({ ...selectedItem, committee_formed_status: e.target.value })}
                    >
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                    </select>
